...
const recipe = new Schema({
    ...
    pictures: {
        type: [String],
        validate: [(pictures) => pictures.length <= 5, 'Maximum 5 pictures'],
    ...
    ingredients: {
        ...
        validate: [
            (ingredients) => ingredients.length > 0 && ingredients.length < 150,
    ...
    prepSteps: {
        ...
        validate: [
            (prepSteps) => prepSteps.length > 0 && prepSteps.length <= 30,
